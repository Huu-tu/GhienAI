      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
          ...
          <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://pagedone.io/asset/uploads/1696245837.png')] ">
            <div className="">
              <div className="">
                <a href="https://www.facebook.com/DTSolutionAuto/" className="flex items-center mb-6">
                  ...
                  <h5 className="text-black text-base  leading-6 ml-5">0388112130</h5>
                </a>
                <a href="https://www.facebook.com/DTSolutionAuto/" className="flex items-center mb-6">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                  ...
                  <h5 className="text-black text-base  leading-6 ml-5">huutu7165@gmail.com</h5>
                </a>
                <a href="javascript:;" className="flex items-center mb-6">
                  ...
                  <h5 className="text-black text-base  leading-6 ml-5">120 Ngo 68, Cau Giay, Ha Noi</h5>
                </a>
                <div className="flex items-center justify-center border-t border-gray-100 pt-6">
                  <a href="https://www.facebook.com/DTSolutionAuto/" className="mr-6">
                  ...
                  <a href="https://www.facebook.com/DTSolutionAuto/" className="mr-6">
                    <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path
                        ...
                        fill="white"></path>
                      <defs>
                        <linearGradient id="paint0_linear_11773_24443" x1="29.4918" y1="30" x2="-0.50824"
                                        y2="-8.07516e-07" gradientUnits="userSpaceOnUse">
